 ...
 */
public class ResourceHandler2 extends HandlerWrapper
{
    private static final Logger LOG = Log.getLogger(ResourceHandler2.class);
...
*/
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
    {
        ...
        if (resource==null || !resource.exists())
        {
            ...
            //Resource welcome = getResource("file:/D:/SANDBOX/IDEA-Android/SparkJava/microsphere/public/test/test.txt");
            //resource = welcome;
        }

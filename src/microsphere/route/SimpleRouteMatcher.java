...
import microsphere.utils.MimeParse;
    ...
    private static class RouteEntry {
        ...
        private boolean matches(HttpMethod httpMethod, String path) {
            if ( (httpMethod == HttpMethod.before || httpMethod == HttpMethod.after)
                            ...
                            && this.path.equals(MicrosphereUtils.ALL_PATHS)) {
        ...
        private boolean matchPath(String path) { // NOSONAR
            ...
            // check params
            List<String> thisPathList = MicrosphereUtils.convertRouteToList(this.path);
            List<String> pathList = MicrosphereUtils.convertRouteToList(path);
